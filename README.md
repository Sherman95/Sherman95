...
<details>
<summary>🤖 Datos curiosos sobre mí</summary>

- 🌙 Programo mejor durante las noches
- ☕ Funciono con café y música electrónica
- 🐛 He pasado horas debuggeando por un punto y coma
- 🚀 Mi IDE favorito es VS Code con tema oscuro
- 📱 Creo que las apps móviles del futuro serán PWAs
- 🎯 Mi meta es crear una app que use millones de personas
- 🧠 Siempre estoy pensando en cómo optimizar procesos
